...
public class MainActivity extends AppCompatActivity implements
    ...
    private void handleSignInResult(GoogleSignInResult result) {
        ...
        if (result.isSuccess()) {
            ...
            new GetClass(MainActivity.this).execute(acct);
...
//            updateUI(true);
    ...
    private class GetClass extends AsyncTask<GoogleSignInAccount, Void, Void> {
        ...
        protected Void doInBackground(GoogleSignInAccount... params) {
            try {
                ...
                final GoogleSignInAccount acct = params[0];
                String call = getString(R.string.server_url) + getString(account) + "/" + acct.getEmail();
                Log.d(TAG, "url:" + call);
                ...
                MainActivity.this.runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        Log.d(TAG, "name:" + acct.getGivenName());
                        Log.d(TAG, "family name:" + acct.getFamilyName());
                        Log.d(TAG, "profile pic url:" + acct.getPhotoUrl());

                        intent.putExtra("fname", acct.getGivenName());
                        intent.putExtra("lname", acct.getFamilyName());
