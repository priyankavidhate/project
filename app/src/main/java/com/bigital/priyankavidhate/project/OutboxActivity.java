...
import com.priyankavidhate.extensions.Inbox.Adapter;
import com.priyankavidhate.extensions.Inbox.ListData;
import com.priyankavidhate.webservices.GetInbox;
import com.priyankavidhate.webservices.GetOrgs;
import com.priyankavidhate.webservices.GetOutbox;
import com.priyankavidhate.webservices.GetPairedOrgs;
...
import static com.bigital.priyankavidhate.project.InboxActivity.bitmap;
...
public class OutboxActivity extends AppCompatActivity
    ...
    private Bundle preWork() {
        ...
        try {
            ...
            output = new GetInbox(this, storage, 0)
                    .execute().get();
